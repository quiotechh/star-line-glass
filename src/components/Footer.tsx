...
const branches = [
  {
    ...
    address:
      "Khasra No - 713, A-Block, Khasra No - 712, Gali No. 1, Industrial Area, Duhai, Ghaziabad, Basantpur Saitli, Uttar Pradesh 201206",
    mapLink:
...
const phoneNumbers = [
  { number: "98110 31849", href: "tel:+919811031849" },
  { number: "98110 31835", href: "tel:+919811031835" },
];
