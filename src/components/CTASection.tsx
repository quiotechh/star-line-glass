...
export default function CTASection() {
  return (
    <section className="relative py-24 lg:py-32 overflow-hidden bg-linear-to-br from-[#1e3a5f] via-[#312e81] to-[#0f172a]">
      {/* Static decorative orbs - CSS only, no JS animations */}
      <div className="absolute top-10 left-10 w-72 h-72 bg-linear-to-br from-white/10 to-transparent rounded-full blur-3xl opacity-20" />
      <div className="absolute bottom-10 right-10 w-96 h-96 bg-linear-to-tl from-brand-secondary/20 to-transparent rounded-full blur-3xl opacity-20" />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold text-white mb-6 leading-tight animate-fade-in-up">
            ...
            <span className="text-blue-200">
              Architecture with Premium Glass?
            </span>
          </h2>
          ...
          <p className="text-lg sm:text-xl text-white/70 mb-12 max-w-2xl mx-auto leading-relaxed animate-fade-in-up animation-delay-200">
            Get expert consultation and competitive quotes for your project. Our
            team is ready to bring your vision to life with world-class glass
            solutions.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-5 mb-16 animate-fade-in-up animation-delay-300">
            ...
            >
              ...
              <span>Call Now: +91 98110 31824</span>
            </a>
        ...
        {/* Bottom Line */}
        <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-2/3 h-px bg-linear-to-r from-transparent via-white/40 to-transparent" />
      </div>
